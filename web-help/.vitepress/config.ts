...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'HAM-Tools — Logbuch, Contest & POTA für macOS' }],
    ['meta', { property: 'og:description', content: 'Anleitungen, FAQ und Tipps zum HAM-Tools macOS-Logger. Multi-Log, Contest mit 14 Templates, POTA-Workflow, CAT für Yaesu/Icom/Kenwood/Elecraft.' }],
    ...
    ['meta', { name: 'twitter:description', content: 'Logbuch, Contest, POTA, CAT-Steuerung. Native macOS-App.' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      description: 'Native macOS-Logger für Funkamateure mit Logbuch, Contest-Modus, POTA-Workflow, DX-Cluster, CAT-Steuerung und Antennen-Rechnern.',
