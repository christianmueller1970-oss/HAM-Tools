...
- [~] **N:** **Logbuch-Modul** — Phase 1 + 2 + 3 + 4b fertig (v1.5.0, 2026-05-11). Siehe `LOGBUCH_PLAN.md` für den vollen Plan.
  ...
  - **Offen:**
    ...
    - [~] **Upload zu QRZ Logbook / LoTW / eQSL** — Phase 6 läuft.
      ...
      - [ ] **QRZ Logbook Confirmation-Sync** — `ACTION=FETCH` zieht alle QSOs als ADIF, matcht via Call+Date+Band+Mode, setzt lotwConfirmed/eqslConfirmed/qslReceivedDate aus den Server-Werten. Trigger im QSLTab als „Bestätigungen abrufen"-Button.
